...
<<<<<<< HEAD
We also wanted to get an evaluation of the prototype, from surveys and observation in different schools. A prototype got developed with time left for an evauation 
but the lack of interest and/or no time for the teachers in the scools, got us one scool offer to try PicoNodes. The evaluation was better then aspected, most of the students
=======
