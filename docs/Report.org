...
LLVM (a dependency of the Rust compiler) does not support. This wasn't as much of a hindrance, since the downloader is mostly responsible
...
Once we were happy with our design we made a more formal design in our \ac{CAD} program KiCad.
...
#+INCLUDE: User_manual_PICONODE-COMPUTE.org :lines "17-"
...
#+INCLUDE: User_manual_PICONODE-SWITCH.org :lines "7-"
