...
# Can't actually find these categories anywhere in HeintzMannila..
...
This study has (attempted to) examine the following questions:

1. How to implement the new learning outcome goals for computational thinking
2. Implementation of a platform to teach students to do hardware-close programming
3. Evaluation of the pedagogical usefulness of the platform, and how you can use
   it to motivate students.
