...
The components should be CE marked to sustain good quality and to insure that induvidual components standards are secured. Also RoHS standards should be uptained  
...
volunteered to evaluate the prototype. To try to gather as much data as possible, family members was asked to participate.
